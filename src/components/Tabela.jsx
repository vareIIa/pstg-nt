...
const rows = [
  ...
  createData('Yan Eduardo Carneiro Cruz', 75, 2, 2, 2, 2, 2, 2, 2, 0, 2, 2, 18, 300),
  ...
  createData('Thiago Santos Madeira', 10, 2, 2, 2, 2, 1, 1, 0, 2, 2, 1, 15, 300),
  createData('Gabriel Henrique Oliveira Pedro', 130, 2, 0, 2, 2, 2, 2, 1, 0, 2, 2, 15, 300),
